# -*- coding: utf-8 -*-
"""
Created on Fri Feb  2 11:38:56 2024
...
image1 =Image.open('f3.jpeg')
image1 =image1.resize((1400,700), Image.LANCZOS)
...
#++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
button1 = tk.Button(framed, text='CNN Prediction',width=15,height=2,bd=5,bg='#152238',font=('times', 15, ' bold '),fg='white',command=image).place(x=100,y=20)
button1 = tk.Button(framed, text='Frogery Detection',width=15,height=2,bd=5,bg='#152238',font=('times', 15, ' bold '),fg='white',command=image2).place(x=100,y=100)
