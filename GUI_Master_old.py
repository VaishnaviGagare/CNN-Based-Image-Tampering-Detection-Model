...
frame_alpr = tk.LabelFrame(root, text=" --Image_Process-- ", width=250, height=380, bd=5, font=('times', 14, ' bold '),bg="black",fg='white')
...
def test_model_proc(fn):
    ...
    if fn!="":
        ...
        return A
    img = open(fn)    
    myfile = open("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/testing")
    if img == myfile:
          print(myfile)
...
def openimage():
    ...
    global fn
    print(fn)
    fileName = askopenfilename(initialdir='D:/23 Protech/100% code/Image Frogery Detection/Image Foregery Detection 100% Code/testing', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
