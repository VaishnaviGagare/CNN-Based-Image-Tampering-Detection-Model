...
def copy_move_forgery():
    ...
    if forgery is None:
        ...
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/no_copy_move.png", IMG_WIDTH, IMG_HEIGHT)
        ...
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/copy_move.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def metadata_analysis():
    ...
    if img_exif is None:
        ...
        # Retrieve the output image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/no_metadata.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/metadata.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def noise_variance_inconsistency():
    ...
    if(noise_forgery):
        ...
        # Retrieve the output image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/varience.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/no_varience.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def cfa_artifact():
    ...
    if(identical_regions_cfa):
        # Retrieve the output image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/cfa.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # print('\nSingle compressed')
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/no_cfa.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
def jpeg_Compression():
    ...
    if(double_compressed):
        ...
        # Retrieve the output image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/double_compression.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
        ...
        # print('\nSingle compressed')
        # Retrieve the thumbs up image and display in resultPanel
        img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/single_compression.png", IMG_WIDTH, IMG_HEIGHT)
        resultPanel.configure(image=img)
        resultPanel.image = img
...
root.iconbitmap('C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/favicon.ico')
...
# Get the blank image
input_img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/input.png", IMG_WIDTH, IMG_HEIGHT)
middle_img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/middle.png", IMG_WIDTH, IMG_HEIGHT)
output_img = getImage("C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/images/output.png", IMG_WIDTH, IMG_HEIGHT)
