...
heading = tk.Label(root,text="Image Foregery Detection",width=120,height=2,font=("Times New Roman",21,"italic"),bg="#152238",fg="white")
...
def VIDEO():
    ...
    fn=""
    fileName = askopenfilename(initialdir='C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code\Image Foregery Detection 100% Code//dataset', title='Select image',
                               filetypes=[("all files", "*.*")])
...
def show_FDD_video(video_path):
    ...
    FALLModel=load_model(r'model2.h5')    #video = cv.VideoCapture(video_path);
    ...
    while True:
        ...
        if  label == 1 :
            label_text = "Foregery Video Detected"
            color = red
            
            
            print('Foregery Video Detected')
...
#    fn=r"D:\Alka_python_2019_20\Alka_python_2019_20\Video Piracy\Piracy_Preserving\result.mp4"
    fileName = askopenfilename(initialdir='C:/Users/vaish/OneDrive/Desktop/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Image Foregery Detection 100% Code/Video/c1.mp4', title='Select image',
                               filetypes=[("all files", "*.*")])
...
button5 = tk.Button(root,command = Video_Verify, text="Video Foregery Detection", width=20,font=("Tempus Sanc ITC",15),bg="brown",fg="black")
